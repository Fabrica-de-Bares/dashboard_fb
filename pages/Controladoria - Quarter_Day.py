...
for categoria in (categorias_quarter):
    if categoria == 'Faturamento Bruto': class_cont = ['FATURAMENTO BRUTO']
        ...
        class_cont = ['Delivery']
        if id_casa not in [114, 148, 116, 104, 105]: # Apenas essas casas tem Delivery
            continue
    ...
    with st.container(border=True): 
        ...
        for ano in lista_anos:
            ...
            if categoria == 'CMV': # Multiplica por 100 para exibir no gráfico
                ...
                lista_valores_mes = df_faturamento_grafico_ano.drop(columns=['Ano']).iloc[0].tolist()
        ...
        if categoria != 'Faturamento Bruto' and categoria != 'CMV':
            ...
            for col in cols_calc:
                ...
                df_percentual[col] = df_categoria[col] / total # Divide faturamento do categoria pelo faturamento total
