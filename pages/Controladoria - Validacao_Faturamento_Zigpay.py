...
def main():
    ...
    with col_casa:
        lista_retirar_casas = ['Priceless', 'Bar Léo - Vila Madalena', 'Todas as Casas', 'Escritório Fabrica de Bares', 'Casa Teste 2', 'Brahminha', 'Blue Note SP (Sala 2)', 'Tempus Fugit  Ltda ', 'Sanduiche comunicação LTDA ', 'Edificio Rolim']
