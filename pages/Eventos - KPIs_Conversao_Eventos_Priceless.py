...
def main():
    ...
    with col0:
        lista_retirar_casas = ['Bar Léo - Vila Madalena', 'Blue Note SP (Novo)', 'Terraço Notie', 'Escritório Fabrica de Bares', 'Blue Note SP (Sala)', 'The Cavern - Almoço', 'Terraço Notie Novo']
