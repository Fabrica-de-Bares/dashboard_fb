...
# Seletor de casa
with col1: 
  # Sala 2 fora: na conciliação ela entra somada ao Blue Note - São Paulo (ver queries_conciliacao.py)
  lista_retirar_casas = ['Todas as Casas', 'Bar Léo - Vila Madalena', 'Blue Note SP (Sala 2)', 'The Cavern - Almoço', 'Brahminha']
