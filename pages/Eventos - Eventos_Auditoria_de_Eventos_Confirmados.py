...
def main():
	...
	with col1:
		# Filtro de casa:
		lista_retirar_casas = ['Bar Léo - Vila Madalena', 'Blue Note SP (Novo)', 'Edificio Rolim', 'Terraço Notie', 'The Cavern - Almoço', 'Blue Note SP (Sala 2)', 'Escritório Fabrica de Bares']
